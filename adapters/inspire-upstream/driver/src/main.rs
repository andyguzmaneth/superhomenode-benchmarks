//! Bench driver for the crates.io `inspire` 0.2.0 baseline.
//!
...
//!
//! Usage:
//!   inspire-upstream-bench --entries-log2 24 --record-bytes 32 \
...
fn main() {
    ...
    eprintln!(
        "inspire-upstream 0.2.0: 2^{} x {}B = {:.2} GB, variant {}",
        args.entries_log2,
        args.record_bytes,
        db_bytes as f64 / 1e9,
        args.variant_label
    ...
    let report = serde_json::json!({
        ...
        "variant": format!("inspire-upstream-0.2.0-{}-inspiring", args.variant_label),
        "scheme_params": {
